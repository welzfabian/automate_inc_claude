...
EVENT_DECISION_GONE = "Dieses Ereignis gibt es im aktuellen Katalog nicht mehr. Erledigt."
EVENT_EFFECT_STARTED = "läuft ab jetzt"
EVENT_NO_EFFECT = "keine Auswirkung"
...
EVENT_EFFECT_ENDED = "„{name}“ ist ausgelaufen."
TURN_BLOCKED = "Eine offene Entscheidung blockiert die Runde. Beantworte sie zuerst."
...
ACTIVE_EVENT_LINE_PERMANENT = "{name} — {label} — dauerhaft"
EVENT_DECISION_HEADER = "Neues Ereignis: {name}"
